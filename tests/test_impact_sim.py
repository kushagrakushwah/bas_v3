...
test_impact_sim.py
==================
Tests the impact_sim module against 192.168.56.102.

Simulates post-exploitation impact: checks for reachable C2 beacon paths,
exposed storage/backup paths, and cloud metadata exposure.

HOW TO USE:
  1. Set API_KEY below.
  2. Run: python tests/test_impact_sim.py
"""
...
def main():
    print("=" * 60)
    print("  SecureForge — Impact Simulation Module Test")
